...
(function (T, V, s) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, l, p, n, r, t, J, w, u, K, Q) {
            ...
            function H(a, c, d, e, g, f, m, p, n) {
                ...
                for (var u =
                    ...
                    }), pa = a.length; else if (F.compile)try {
    ...
    function Ud() {
        var b = /^\s*(\[|\{[^\{])/, a = /[\}\]]\s*$/, c = /^\)\]\}',?\n/, d = {"Content-Type": "application/json;charset=utf-8"}, e = this.defaults = {
            ...
            headers: {common: {Accept: "application/json, text/plain, */*"}, post: la(d), put: la(d), patch: la(d)},
    ...
    var Ka = S.prototype = {
        ...
        }, length: 0, push: Ne, sort: [].sort, splice: [].splice
    }, lb = {};
    ...
    Qb.prototype = Pb.prototype = Bc.prototype = {
        $$html5: !1, $$replace: !1, absUrl: pb("$$absUrl"), url: function (a, c) {
        ...
        constructor: Sb, lex: function (a) {
            ...
            for (this.tokens = []; this.index < this.text.length;) {
                ...
                if (this.is("\"'"))this.readString(this.ch); else if (this.isNumber(this.ch) ||
                    this.is(".") && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(this.ch))this.readIdent(); else if (this.is("(){}[].,;:?"))this.tokens.push({
                    index: this.index,
                    text: this.ch
    ...
    var Rc = function (a) {
            ...
            text: wb, number: function (a, c, d, e, g, f) {
                wb(a, c, d, e, g, f);
            ...
            return {
                require: ["ngModel", "^?form"], controller: Xe, link: function (a, c, d, e) {
                    var g = e[0], f = e[1] || ub;
                    f.$addControl(g);
