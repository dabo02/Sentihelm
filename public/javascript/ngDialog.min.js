...
!function (a, b) {
    "use strict";
    var c = b.module("ngDialog", []), d = b.element, e = b.isDefined, f = (document.body || document.documentElement).style, g = e(f.animation) || e(f.WebkitAnimation) || e(f.MozAnimation) || e(f.MsAnimation) || e(f.OAnimation), h = "animationend webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend", i = !1;
    c.provider("ngDialog", function () {
        ...
        this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", function (i, l, m, n, o, p, q, r) {
            ...
            var t = {
                ...
                open: function (g) {
                    function h(a) {
                        return a ? b.isString(a) && v.plain ? a : l.get(a) || o.get(a, {cache: !0}) : "Empty template"
                    }

                    var i = this, v = b.copy(c);
                    ...
                    return n.when(h(v.template)).then(function (c) {
                        return c = b.isString(c) ? c : c.data && b.isString(c.data) ? c.data : "", l.put(v.template, c), v.showClose && (c += '<div class="ngdialog-close"></div>'), i.$result = x = d('<div id="ngdialog' + f + '" class="ngdialog"></div>'), x.html('<div class="ngdialog-overlay"></div><div class="ngdialog-content">' + c + "</div>"), v.controller && b.isString(v.controller) && x.attr("ng-controller", v.controller), v.className && x.addClass(v.className), v.data && b.isString(v.data) && (z.ngDialogData = "{" === v.data.replace(/^\s*/, "")[0] ? b.fromJson(v.data) : v.data), y = v.appendTo && b.isString(v.appendTo) ? b.element(document.querySelector(v.appendTo)) : s, z.closeThisDialog = function () {
                            ...
                            var b = v.closeByDocument ? d(a.target).hasClass("ngdialog-overlay") : !1, c = d(a.target).hasClass("ngdialog-close");
                            (b || c) && u.close(x.attr("id"))
                        }, "undefined" != typeof a.Hammer ? a.Hammer(x[0]).on("tap", e) : x.bind("click", e), j += 1, u
                    }), {
                        id: "ngdialog" + f, closePromise: w.promise, close: function () {
                            t.closeDialog(x)
                        }
                    }
                }, openConfirm: function (a) {
                    var c = n.defer(), d = {closeByEscape: !1, closeByDocument: !1};
