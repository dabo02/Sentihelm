...
angular.module("naif.base64", []).directive("baseSixtyFourInput", ["$window", function (a) {
    return {
        restrict: "A", require: "ngModel", link: function (b, c, d, e) {
            ...
            var g = {};
            b.readerOnload = function (a) {
                var c = f(a.target.result);
                g.base64 = c, b.$apply(function () {
                    e.$setViewValue(g)
                })
            };
            var h = new FileReader;
            h.onload = b.readerOnload, c.on("change", function () {
                var a = c[0].files[0];
                g.filetype = a.type, g.filename = a.name, g.filesize = a.size, h.readAsArrayBuffer(a)
            })
        }
    }
}]);