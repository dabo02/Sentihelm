  ...
  function startServer(io) {
    ...
    var createConnection = function (clientId) {
      return function onConnection(socket) {
        ...
        // Routes the message around the system, the message gets encyrpted if the sender was an officer and it gets decrypted for an officer if the sender was mobile client.
        var routeMessage = function (message, chatId) {
            ...
            usersModel.getUsername(message.receiver)
              .then(function (username) {
                ...
                var encryptedmessage = {
                  fromMe: true,
                  from: socket.session.user.username,
          ...
          if (socket.mobileSession) {
            ...
            var decryptedMessage = {
              fromMe: false,
              from: socket.mobileSession.username,
